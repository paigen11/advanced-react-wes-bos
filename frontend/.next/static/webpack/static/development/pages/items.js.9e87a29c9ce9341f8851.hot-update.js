  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      var data = cache.readQuery({
        ALL_ITEMS_QUERY: _Items__WEBPACK_IMPORTED_MODULE_3__["ALL_ITEMS_QUERY"]
      });
      console.log(data, payload); // 2. filter the deleted item out of the page
      // data.items = data.items.filter(item => item.id !== payload.data.id)
    });
...
//# sourceMappingURL=items.js.9e87a29c9ce9341f8851.hot-update.js.map